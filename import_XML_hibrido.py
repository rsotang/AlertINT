...
################################################################################################################################################   
def transform_data(all_data):#pilla las colummnas que nos interesan y las limpia
...
def main():
    ...
    log_filename = f'Z:\Dosis pacientes\Alertas_Intervencionismo\_PRUEBAS EN CURSO-AlertInt python\_Logs errores\Hibrido\error_log_{current_date}.txt'
...
############################################################################
    try:  #ESTE ES EL CODIGO DE VERDAD  
        ...
        input_dir = 'Z:\Dosis pacientes\Alertas_Intervencionismo\Historial pacientes\Hibrido'
        print('Buscando pacientes de Hibrido en ' + input_dir)
